...
function ContactIcon({ label }: { label: string }) {
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M3.5 7.2c0-.28-.1-.5-.33-.66L2.5 5.8v-.45h5.1l3.95 8.66 3.47-8.66h4.86v.45l-.57.55c-.2.15-.3.38-.27.66v6.98c-.03.28.06.5.27.66l.56.55v.45h-4.93v-.45l.58-.56c.2-.2.2-.25.2-.55V8.45l-4.57 11.56h-.62L5.18 8.45v7.75c-.04.4.1.8.37 1.07l.75.91v.45H2.5v-.45l.75-.91c.27-.28.4-.67.35-1.07V7.2h-.1Zm14.63 0v6.98c0 .3 0 .35.2.55l.58.56v.45h-4.93v-.45l.56-.55c.2-.16.3-.38.27-.66V7.1c.03-.28-.06-.51-.27-.66l-.56-.55v-.45h4.93v.45l-.58.56c-.2.2-.2.25-.2.55v.2Z"
      />
    </svg>
  );
